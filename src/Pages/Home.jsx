...
const Home = () => {
    return (
        <div className="px-1 bg-[#121212] transition-all duration-200 dark:bg-slate-200 min-h-screen">
            <div className=" pt-12 px-4 md:pt-28 md:px-16 " data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            ...
            <div className="pt-20 pb-10 md:pt-56 md:pb-20">
                <div className="px-4 py-4 max-w-sm  mx-auto rounded-lg md:px-16 md:py-16  md:max-w-6xl bg-[#28292a] dark:bg-white dark:text-black" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
            ...
            <div className="pb-20 pt-12 px-4 md:pt-24 md:px-16">
                <div >
                    ...
                    <div className="flex justify-start mt-10">
                        <div className="bg-[#28292a] w-72 h-auto p-6 rounded-2xl dark:bg-white dark:text-blac"data-aos="fade-down" data-aos-duration="600" data-aos-once="true">
                            ...
                            <div className="flex gap-5 md:gap-2 mt-1">
                                <AiFillHtml5 size={18} color="white" className="" />
                            ...
                            <button className="bg-black text-white px-10 py-1 rounded-lg mt-2 hover:-translate-y-0.5 hover:bg-slate-600"><a href="http://knowtydark.netlify.app/">Visit</a> </button>
                        </div>
                    </div>
                </div>
            </div>
