...
const Home = () => {
    return (
        <div className="px-1 bg-[#121212] transition-all duration-200 dark:bg-slate-100 min-h-screen">
            <div className="pt-12 px-4 md:pt-28 md:px-16 " data-aos="fade-up" data-aos-duration="600" data-aos-once="true">
            ...
            <div className="pt-20 pb-10 md:pt-56 md:pb-20">
                <div className="mx-4 py-4 p-2 md:mx-auto  rounded-lg md:px-16 md:py-16  md:max-w-6xl bg-[#28292a] dark:bg-white dark:text-black dark:shadow-lg" data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
                    ...
                    <div className="flex gap-3 md:gap-20 justify-center mt-3">
                ...
                <div>
                    ...
                    <div className="flex justify-start mt-10">
                        <div className="bg-[#28292a] w-72 h-auto p-6 rounded-2xl dark:bg-white dark:text-black dark:shadow-lg"data-aos="fade-down" data-aos-duration="600" data-aos-once="true">
                            ...
                            <button className="bg-black text-white px-10 py-1 rounded-lg mt-2 transition-colors duration-200 hover:bg-slate-600"><a href="http://knowtydark.netlify.app/">Visit</a> </button>
                        </div>
                    </div>
                </div>
            </div>
