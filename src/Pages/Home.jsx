                ...
                <div>
                    ...
                    <div className="flex justify-start mt-10">
                        <div className="bg-[#28292a] w-72 h-auto p-6 rounded-2xl dark:bg-white dark:text-black dark:shadow-lg"data-aos="fade-down" data-aos-duration="600" data-aos-once="true">
                            ...
                            <button className="bg-black text-white px-10 py-1 rounded-lg mt-4 transition-colors duration-200 hover:bg-slate-600"><a href="http://knowtydark.netlify.app/">Visit</a> </button>
                        </div>
                    </div>
                </div>
            </div>
