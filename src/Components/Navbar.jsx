            ...
            <nav className="bg-[#121212] dark:bg-slate-100 text-white dark:text-black w-full pt-5 md:pt-12  transition-all duration-200 px-5 md:px-20">
                <div className="flex justify-between text-xl ">
                    ...
                    <div className="flex gap-4 justify-end md:hidden">
                        {
                            Icon
                                ?
                                <span className="block md:hidden rounded-full bg-slate-700 p-2 cursor-pointer hover:bg-slate-600 w-auto h-10 dark:bg-slate-300 hover:origin-center hover:-rotate-12 transition-all duration-200 scale-125"><HiMoon size={24} onClick={function () { toggleTheme(); toggleIcon() }} /></span>
                                :
                                <span className="block md:hidden rounded-full bg-slate-700 p-2 cursor-pointer w-auto h-10 dark:bg-slate-300 hover:origin-center hover:-rotate-45 transition-all duration-200 scale-125"><HiSun size={24} onClick={function () { toggleTheme(); toggleIcon() }} /></span>
                        }
                    ...
                    </div>
                    {
                        navbar
                            ?
                            <div className="h-screen w-full top-0 left-0 z-20 bg-black fixed  transition-all duration-500 md:hidden" data-aos="fade-down" data-aos-duration="600">
